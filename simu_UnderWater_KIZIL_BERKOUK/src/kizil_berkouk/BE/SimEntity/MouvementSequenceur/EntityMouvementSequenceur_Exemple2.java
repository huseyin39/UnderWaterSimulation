...
public class EntityMouvementSequenceur_Exemple2 extends EntityMouvementSequenceur implements IMover{
	private static int NbDrone = ScenarioInstanceBE.nbDrone;

	
	public EntityMouvementSequenceur_Exemple2(String name, SimFeatures features) {
		super(name, features);
