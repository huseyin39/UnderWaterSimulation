...
public class ScenarioInstanceBE3 implements IScenarioInstance{
	...
	public IScenario getScenarioInstance() {
		...
		positionsCles31.put("PointCible1", new Point3D(-6000, 2000, 0));
		positionsCles31.put("PointCible1b", new Point3D(-6000,-6000,0));
		
		// Trajectory D2 -- 3
		HashMap<String,Point3D> positionsCles32 = new HashMap<String, Point3D>();
		positionsCles32.put("start", new Point3D(0, 0, 0));
		positionsCles32.put("PointCible2b", new Point3D(-6000, 6000, 0));
		positionsCles32.put("PointCible2", new Point3D(2000, 6000, 0));
		positionsCles32.put("PointCible3", new Point3D(2000, -2000, 0));
		// Trajectory D3 -- 3
		HashMap<String,Point3D> positionsCles33 = new HashMap<String, Point3D>();
		positionsCles33.put("start", new Point3D(0, 0, 0));
		positionsCles33.put("PointCible4", new Point3D(6000,-6000,0));
		positionsCles33.put("PointCible5", new Point3D(10000,-6000,0));
		positionsCles33.put("PointCible6", new Point3D(10000,6000,0));
		...
		//Drone 2
		mstDrone= new MovableState(new Point3D(0,0,0),new Point3D(Math.sqrt(2)*4, Math.sqrt(2)*4,0), Point3D.ZERO, Point3D.ZERO, Point3D.ZERO, Point3D.ZERO);
		msiDrone= new EntityMouvementSequenceurInit("MSI3Drones", mstDrone,  4, 0, 1, 3, positionsCles32);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
