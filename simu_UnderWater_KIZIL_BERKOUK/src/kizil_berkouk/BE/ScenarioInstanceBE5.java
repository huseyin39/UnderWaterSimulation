...
public class ScenarioInstanceBE5 implements IScenarioInstance {
	...
	public IScenario getScenarioInstance() {
		...
		positionsCles51.put("PointCible1", new Point3D(-6000, 2000, 0));
		positionsCles51.put("PointCible1b", new Point3D(-6000,-6000,0));		
		// Trajectory D1 -- 5D
		HashMap<String,Point3D> positionsCles52 = new HashMap<String, Point3D>();
		positionsCles52.put("start", new Point3D(0, 0, 0));
		positionsCles52.put("PointCible2b", new Point3D(-6000, 6000, 0));
		positionsCles52.put("PointCible2", new Point3D(2000, 6000, 0));
		
		// Trajectory D2 -- 5D
		HashMap<String,Point3D> positionsCles53 = new HashMap<String, Point3D>();
		positionsCles53.put("start", new Point3D(0, 0, 0));
		positionsCles53.put("PointCible3", new Point3D(2000, -2000, 0));
		
		// Trajectory D3 -- 5D
		HashMap<String,Point3D> positionsCles54 = new HashMap<String, Point3D>();
		positionsCles54.put("start", new Point3D(0,0,0));
		positionsCles54.put("PointCible4b", new Point3D(2000, -6000, 0));
		positionsCles54.put("PointCible4", new Point3D(10000, -6000, 0));
		
		// Trajectory D4 -- 5D
		HashMap<String,Point3D> positionsCles55 = new HashMap<String, Point3D>();
		positionsCles55.put("start", new Point3D(0, 0, 0));
		positionsCles55.put("PointCible5", new Point3D(10000, -2000, 0));
		positionsCles55.put("PointCible5b", new Point3D(10000, 6000, 0));
		...
		msiDrone= new EntityMouvementSequenceurInit("MSI5Drones", mstDrone,  4, 0, 1, 3, positionsCles51);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
		kizil_berkouksf.getDrones().put(new EntityDroneFeature("Drone5", 10, 5, Color.BLACK, msfDrone, kizil_berkouksf), new EntityDroneInit("Drone1", msiDrone));
		
		//Drone 1
		mstDrone= new MovableState(new Point3D(0,0,0),new Point3D(Math.sqrt(2)*4, Math.sqrt(2)*4,0), Point3D.ZERO, Point3D.ZERO, Point3D.ZERO, Point3D.ZERO);
		msiDrone= new EntityMouvementSequenceurInit("MSI5Drones", mstDrone, 4, 0, 1, 3, positionsCles52);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
		...
		// Drone 2
		mstDrone= new MovableState(new Point3D(0,0,0),new Point3D(Math.sqrt(2)*4, Math.sqrt(2)*4,0), Point3D.ZERO, Point3D.ZERO, Point3D.ZERO, Point3D.ZERO);
		msiDrone= new EntityMouvementSequenceurInit("MSI5Drones", mstDrone, 4, 0, 1, 3, positionsCles53);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
		...
		//Drone 3
		mstDrone= new MovableState(new Point3D(0,-0,0),new Point3D(Math.sqrt(2)*4, Math.sqrt(2)*4,0), Point3D.ZERO, Point3D.ZERO, Point3D.ZERO, Point3D.ZERO);
		msiDrone= new EntityMouvementSequenceurInit("MSI5Drones", mstDrone, 4, 0, 1, 3, positionsCles54);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
		...
		//Drone 4
		mstDrone= new MovableState(new Point3D(0,0,0),new Point3D(Math.sqrt(2)*4, Math.sqrt(2)*4,0), Point3D.ZERO, Point3D.ZERO, Point3D.ZERO, Point3D.ZERO);
		msiDrone= new EntityMouvementSequenceurInit("MSI5Drones", mstDrone, 4, 0, 1, 3, positionsCles55);
		msfDrone = new EntityMouvementSequenceurFeature("MSF");
		kizil_berkouksf.getDrones().put(new EntityDroneFeature("Drone4", 10, 5, Color.PURPLE, msfDrone, kizil_berkouksf), new EntityDroneInit("Drone5", msiDrone));
