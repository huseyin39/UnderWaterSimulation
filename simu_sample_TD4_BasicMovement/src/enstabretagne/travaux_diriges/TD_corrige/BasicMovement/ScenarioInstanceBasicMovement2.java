...
public class ScenarioInstanceBasicMovement2 implements IScenarioInstance {
	...
	public IScenario getScenarioInstance() {
		...
		msi = new EntityMouvementSequenceurInit("MSI", mst, 10, 100,2,8, positionsCles);
		feat = new EntityMouvementSequenceurFeature("MSF");
		bsf.getNavires().put(new EntityNavireFeature("NavireF",5,3,Color.GREEN,feat), new EntityNavireInit("Navire Observation 2", msi));
		...
		msi = new EntityMouvementSequenceurInit("MSI", mst, 10, 100,2,8, positionsCles);
		feat = new EntityMouvementSequenceurFeature("MSF");
		bsf.getNavires().put(new EntityNavireFeature("NavireF",5,3,Color.BROWN,feat), new EntityNavireInit("Navire Observation 3", msi));
